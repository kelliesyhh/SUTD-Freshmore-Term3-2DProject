...
def predictcases():
 ...
 [[5072.177496453898],
  ...
  [-732.3316114544484],
  [371.8501380158209]],
  [[21327.6051965 ], [ 3755.24141949], [18513.43631444], [-1335.93848313], [ 3203.42058438], [-2556.16610382]]]
	...
	print(beta)
	y = beta[0][0] + beta[1][0]*testing_policy + beta[2][0]*vaccination_policy + beta[3][0]*facial_coverings + beta[4][0]*restriction_gatherings + beta[5][0]*stay_home
	print(y)
